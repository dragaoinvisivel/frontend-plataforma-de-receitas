  ...
  return (
    <>
      ...
      >
        ...
        <Controls.Group className="flex w-full items-center px-2 bg-[hsl(222.2,11.22%,1.55%)]">
          <Sliders.Time thumbnails={thumbnails} />
        </Controls.Group>
        <Controls.Group className="-mt-0.5 flex w-full items-center px-2 pb-2 bg-[hsl(222.2,11.22%,1.55%)]">
